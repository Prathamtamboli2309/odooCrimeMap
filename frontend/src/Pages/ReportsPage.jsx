...
const CrimeReports = () => {
  ...
  const fetchCrimeReports = async () => {
    try {
      ...
      setFilteredReports(sortedReports); // Initialize filtered reports with sorted data
      setIsLoading(false);
    } catch (error) {
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center  gap-4">
        ...
        <div className="mt-6">
          <button
            ...
            className="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 mt-12 md:mt-0"
          >
            Clear Filters
          </button>
        </div>
